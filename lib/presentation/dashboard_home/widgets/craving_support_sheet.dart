...
class _CravingSupportSheetState extends State<CravingSupportSheet>
  ...
  late final List<Map<String, dynamic>> _supportOptions;

  late final List<String> _motivationalQuotes;

  late final List<String> _distractionActivities;
  ...
  void didChangeDependencies() {
    ...
    _supportOptions = [
      {
        "title": l10n.breathing_exercise_title,
        "subtitle": l10n.breathing_exercise_subtitle,
        "icon": "air",
        "color": Color(0xFF4CAF50),
        "action": "breathing"
      },
      {
        "title": l10n.motivational_quote_title,
        "subtitle": l10n.motivational_quote_subtitle,
        "icon": "psychology",
        "color": Color(0xFF2E7D8F),
        "action": "quote"
      },
      {
        "title": l10n.emergency_contact_title,
        "subtitle": l10n.emergency_contact_subtitle,
        "icon": "phone",
        "color": Color(0xFFFF6B35),
        "action": "contact"
      },
      {
        "title": l10n.distraction_activity_title,
        "subtitle": l10n.distraction_activity_subtitle,
        "icon": "sports_esports",
  ...
  Widget _buildSupportOptions() {
    return Padding(
      ...
      child: Column(
        children: [
          Text(
            AppLocalizations.of(context)!.chooseWhatHelpsYouMostRightNow,
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 2.h),
          Text(
            AppLocalizations.of(context)!.fourSevenEightTechniqueDescription,
            style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  color: AppTheme.textMediumEmphasisLight,
                ),
            textAlign: TextAlign.center,
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            SizedBox(width: 3.w),
            Text(AppLocalizations.of(context)!.youveGotThis),
          ],
        ),
        content: Text(
          quote,
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            SizedBox(width: 3.w),
            Text(AppLocalizations.of(context)!.emergencySupport),
          ],
        ),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text(AppLocalizations.of(context)!.callYourSupportPersonOrQuitline),
            SizedBox(height: 2.h),
            ElevatedButton.icon(
              onPressed: () {},
              icon: CustomIconWidget(
