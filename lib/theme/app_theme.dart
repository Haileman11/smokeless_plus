...
/// A class that contains all theme configurations for the smoking cessation application.
/// Implements the "Breathe Fresh Palette" with Purposeful Wellness Minimalism design approach.
class AppTheme {
  AppTheme._();

  // Breathe Fresh Palette - Core Colors
  static const Color primaryLight =
      Color(0xFF2E7D8F); // Deep teal for trust and medical credibility
  static const Color primaryVariantLight =
      Color(0xFF1E5A6B); // Darker teal variant
  static const Color secondaryLight =
      Color(0xFF4CAF50); // Fresh green for health progress
  static const Color secondaryVariantLight =
      Color(0xFF27AE60); // Vibrant green for milestones
  static const Color accentLight =
      Color(0xFFFF6B35); // Warm orange for celebrations
  static const Color backgroundLight =
      Color(0xFFFAFBFC); // Soft off-white for extended reading
  static const Color surfaceLight = Color(0xFFFFFFFF); // Pure white for cards
  static const Color errorLight =
      Color(0xFFE74C3C); // Muted red for system errors only
  static const Color warningLight =
      Color(0xFFF39C12); // Gentle amber for craving alerts
  static const Color successLight =
      Color(0xFF27AE60); // Vibrant green for achievements
  static const Color onPrimaryLight = Color(0xFFFFFFFF);
  static const Color onSecondaryLight = Color(0xFFFFFFFF);
  static const Color onBackgroundLight =
      Color(0xFF2C3E50); // Dark blue-gray for optimal readability
  ...
  static const Color textHighEmphasisLight =
      Color(0xFF2C3E50); // Primary text color
  static const Color textMediumEmphasisLight =
      Color(0xFF7F8C8D); // Secondary text color
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme with clean medical aesthetic
    ...
    // FAB theme for quick actions during craving moments
    ...
    // Typography using Inter for headings and body text
    textTheme: _buildTextTheme(isLight: true),

    // Input decoration optimized for health data entry
    ...
    // Checkbox theme for goal tracking
    ...
    // Progress indicator for health milestones
    ...
    // SnackBar theme for supportive messages
  ...
  /// Dark theme maintaining wellness aesthetic for night usage
  ...
  /// Uses Inter for headings and body text as specified in design system
